...
export function uni2zg(output: string): string {
...
export function zg2uni(output: string): string {
  if (!output) return output;
  var rule = [
    {
        "from" : "([\u102D\u102E\u103D\u102F\u1037\u1095])\\1+",
...
function replace_with_rule(rule: Array<{ from: string; to: string }>, output: string): string {
